...
def process_input_contract_worker(args: Tuple) -> Optional[str]:
    ...
    logger = DebugLogger()
    k = int(os.environ["K"])
    use_cot = bool(os.environ["USE_COT"])
    ...
    try:
        ...
        similar_docs = retriever.retrieve(input_doc, k=k)
        ...
        for doc in similar_docs:
            ...
            try:
                ...
                similar_contexts.append(
                    ...
                    f"#### Similar Contract Code:\n{similar_source_code}\n"
                    f"#### Similar Contract Analysis:\n{analysis_response}\n\n"
                )
        ...
        try:
            response = llm_processor.analyze_contract(source_code, similar_contexts, use_cot)
