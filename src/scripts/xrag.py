...
def main(args):
    ...
    try:
        ...
        # Set number of similar contracts to retrieve as an environmental variable
        os.environ["K"] = str(args.k)

        # Set whether to use CoT as an environmental variable
        os.environ["USE_COT"] = str(args.use_cot)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, help="OpenAI or Google model name.",
                        choices=['gpt-4o', 'o3-mini', 'gpt-4.1', 'o4-mini', 'gemini-2.5-flash-preview-05-20',
    ...
    parser.add_argument("--use-cot", action="store_true",
                        help="Enable CoT reasoning for contract analysis.")
    parser.add_argument("--k", type=int, default=3, help="Number of similar contracts to retrieve.")
